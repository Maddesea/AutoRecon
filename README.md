...
If a scan matches a defined pattern, a file called \_patterns.log will also appear in the scans directory 
with details about the matched output.
...
I MADE SOME CHANGES TO THIS README.md FILE AGAINgit add README.md !
